    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('typeSelling', models.CharField(choices=[('Unidad', 'Unidad'), ('Libra', 'Libra')], default='unit', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delivery_man', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='deliveries', to=settings.AUTH_USER_MODEL)),
